...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Producto_has_Restaurante` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Producto_has_Restaurante` (
  ...
  `Restaurante_idRestaurante` INT NOT NULL,
  `cantidad` INT NULL,
  PRIMARY KEY (`Producto_nombreProducto`, `Producto_MedidasProducto_idMedidasProducto`, `Restaurante_idRestaurante`),
  INDEX `fk_Producto_has_Restaurante_Restaurante1_idx` (`Restaurante_idRestaurante` ASC) ,
  INDEX `fk_Producto_has_Restaurante_Producto1_idx` (`Producto_nombreProducto` ASC, `Producto_MedidasProducto_idMedidasProducto` ASC) ,
